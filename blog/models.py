...
# - override метод стандартного менеджера objects
#  get_queryset, Который вызывает этот же метод родителя и
#  применяет фильтр
...
class Comment(models.Model):
    post = models.ForeignKey(Post,
                             on_delete=models.CASCADE,
                             related_name='comments')  # retrieving post's comments: post.comments.all()
